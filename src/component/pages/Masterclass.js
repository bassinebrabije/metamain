...
import WorldImage from "../../images/home/human-brain-ouq.png"; // Update the path to your image file
        ...
        >
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 relative">
                <div className="shadow rounded-xl">
                    <div className="grid overflow-hidden text-white shadow-xl md:grid-cols-2 bg-[#2e2f68] rounded-xl">
                        {/* Left Image */}
