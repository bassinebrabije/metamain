                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    <div className="mb-5 flex justify-center group cursor-pointer">
                        <p className="relative rounded-full px-3 py-1  text-sm leading-6 border border-[#000678A6] overflow-hidden hover:scale-105 transition duration-300 ease-in-out">
                            <span className="relative text-[#000678A6]">Welcome to meta learning Hub </span>
                        </p>
                    </div>
                    <h1 className="max-w-2xl mx-auto text-center text-[35px] sm:text-[60px] font-bold text-[#00213E] leading-tight">
                        Gives your brain tools for greatness
                    </h1>
                    ...
                    <div class="group relative inline-flex">
                        ...
                        <div class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-[#2e2f68] md:inline-flex">
                    ...
                    {/* <div className="relative mx-auto mt-10 mb-4 sm:pt-10">
                        <div className="lg:max-w-4xl lg:mx-auto">
                            <img className="px-4 md:mpx-8" src={heroimg} alt="MetaHero" loading="lazy" />
                        </div>
                    </div> */}
                </div>
            </section>
